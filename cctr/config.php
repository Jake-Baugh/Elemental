<?php
    ...
    define( 'K_DB_NAME', 'cctr_repod' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'cctr_repodu' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', '@ac68ygBJoDrT79Lg' );
    // 7.
